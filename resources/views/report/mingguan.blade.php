...
@section('title')
    @lang("MasterData.report.repweek")
@endsection
...
@section('content')
    <div class="table-wrapper">
        <div class="table-header">
            <h4 class="table-header-text">@lang("MasterData.report.repweek")</h4>
        ...
        <div class="table-body">
            <table class="table" id="table">
                ...
                <tbody>
                    ...
                    @endfor
                    <tr>
                        <td colspan="2">@lang("MasterData.report.sum")</td>
    ...
    <div class="modal-wrapper" id="modal">
        ...
        <div class="modal">
            <form action="/report/mingguan" method="GET">    
